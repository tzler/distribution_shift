#!/bin/bash
# usage: eval_one.sh <cat> <cond>   — evaluates the newest checkpoint on the held-out BANK trials (traintrials_all.csv)
CAT=$1; COND=$2
