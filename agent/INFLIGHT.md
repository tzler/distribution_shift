...
- **Seed replicates** chair_c0_all_s43/s44 resubmitted (8528180–81) after `splits.random_seed` proved not to be a key (only `system.random_seed` and `dataset_generation.seed` are). Everything else in batch 2 is complete and analysed (D21).
