...
- Nothing running. All of batch 2 complete and analysed (D21–D26). Seed floor 0.0035 per trial. Awaiting the lead on round 3 (random subsets at N = 25 per category on pair-distance-matched bank trials; targeted subsets around chosen MOCHI trials).
